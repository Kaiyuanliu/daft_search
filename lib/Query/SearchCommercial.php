...
/**
 * The Search Commercial Property Class
 *
...
class SearchCommercial extends ApiResource
{
    /**
     * @param array|null $params The parameters for searching commercial property
     * @param array|null $opts   The optional parameters for soap request
     *
     * @return SearchCommericial
     */
